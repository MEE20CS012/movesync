...
OPEN_DOCS_ACTION_NAME = "Developers"
FREEMOCAP_FOUNDATION_ACTION_NAME = "Movesync GGithub"

DONATE_ACTION_NAME = "Movesync"
...
class Actions:
    def __init__(self, freemocap_main_window):
        ...
        self.open_docs_action.triggered.connect(
            lambda: QDesktopServices.openUrl(QUrl("https://imgbb.host/images/2dHVZ.jpeg"))
        )
        ...
        self.freemocap_foundation_action.triggered.connect(
            lambda: QDesktopServices.openUrl(QUrl("https://github.com/movesync/movesync"))
        )
