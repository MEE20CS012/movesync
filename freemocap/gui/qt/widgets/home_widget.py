...
class HomeWidget(QWidget):
    ...
    def _make_version_label(self):
        ...
        version_label_string = f'source:<a href="https://github.com/movesync/movesync" style="color: #777777;"> {freemocap.__version__}</a>'
    ...
    def _add_text_links(self):
        ...
        self._layout.addLayout(hbox)
        hbox.addStretch(1)
        privacy_policy_link_string = '<a href="https://freemocap.github.io/documentation/community/privacy_policy/" style="color: #333333;"> </a>'
        privacy_policy_link_label = QLabel(privacy_policy_link_string)
        privacy_policy_link_label.setOpenExternalLinks(False)
        hbox.addWidget(privacy_policy_link_label)
        docs_string = '<a href="https://freemocap.github.io/documentation/" style="color: #333333;"> </a>'
        docs_string = QLabel(docs_string)
        docs_string.setOpenExternalLinks(False)
        hbox.addWidget(docs_string, alignment=Qt.AlignmentFlag.AlignCenter)
        feedback_string = '<a href="https://forms.gle/AguGxQAJGXxaJbXdA" style="color: #333333;"> </a>'
        feedback_string = QLabel(feedback_string)
        feedback_string.setOpenExternalLinks(False)
        hbox.addWidget(feedback_string, alignment=Qt.AlignmentFlag.AlignRight)
        donate_string = '<a href="https://freemocap.org/about-us.html#donate" style="color: #333333;"> </a>'
        donate_string = QLabel(donate_string)
        donate_string.setOpenExternalLinks(False)
    ...
    def _welcome_to_freemocap_title(self):
        logger.debug("Creating `WELCOME TO MOVESYNC` layout")

        session_title_label = QLabel("MOTION CAPTURE!")
