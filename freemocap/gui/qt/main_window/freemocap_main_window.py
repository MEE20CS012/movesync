...
class MainWindow(QMainWindow):
    def __init__(
        ...
        logger.info("Initializing Movesync MainWindow")

        self.setMinimumSize(1280, 720)
        self.setWindowIcon(QIcon(PATH_TO_FREEMOCAP_LOGO_SVG))
        self.setWindowTitle("Movesync \U0001F480 \U00002728")
        ...
        logger.debug("Finished initializing Movesync MainWindow")
    ...
    def open_welcome_screen_dialog(self):
        logger.info("Opening `Welcome to Movesync` dialog... ")
